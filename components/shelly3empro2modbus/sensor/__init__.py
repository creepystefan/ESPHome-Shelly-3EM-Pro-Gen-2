...
shelly3empro2modbus_ns = cg.esphome_ns.namespace("shelly3empro2modbus")
ShellyModbus = shelly3empro2modbus_ns.class_("ShellyModbus", sensor.Sensor, cg.PollingComponent)


CONFIG_SCHEMA = cv.Schema(
    sensor.sensor_schema(ShellyModbus)
    .extend(
        {
        cv.GenerateID(): cv.declare_id(ShellyModbus),
